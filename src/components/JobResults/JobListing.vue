        ...
        <div>
          ...
          <div>
            <ul class="list-disc pl-8">
              ...
              <li>
                Experience in cloud computing (e.g., infrastructure, storage,
                platforms, data), cloud market dynamics and customer buying
                behavior.
              </li>
              <li>
                Experience in DevOps best practices (e.g., Continuous
